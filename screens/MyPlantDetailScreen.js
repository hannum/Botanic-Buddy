            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.headerContainer}>
                    <View style={styles.leftHeaderContainer}>
                        <Text style={styles.plantName}>Mikrokosmos</Text>
                        <Text style={styles.timeStamp}>Last checked: Just now</Text>
                ...
                <View style={styles.indexContainer}>
                    <View style={styles.plantScoreContainer}>
                        ...
                        <View style={styles.percentageContainer}>
                            <Text style={{fontFamily: 'bold', color: Colors.Green, fontSize: 14}}>78%</Text>
                        </View>
                    </View>
                    <TouchableOpacity>
                ...
                <View style={styles.plantDetailsContainer}>
                    ...
                    <View style={styles.aBoxDetailContainer}>
                        <View style={styles.topBox}>
                            <View style={styles.boxIndex}>
                                <Text style={styles.boxIndexNumber}>23</Text>
                        ...
                        <View style={styles.bottomBox}>
                            <Text style={styles.boxTitle}>Water Temp</Text>
                    ...
                    <View style={styles.aBoxDetailContainer}>
                        <View style={styles.topBox}>
                            <View style={styles.boxIndex}>
                                <Text style={styles.boxIndexNumber}>27.4</Text>
                                <Text style={styles.boxIndexSymbol}>°C</Text>
                            </View>
                            <View style={styles.statusIndicator}>
                                <Feather name='check' size={14} color='#fff'/>
                ...
                <View style={styles.plantDetailsContainer}>
                    ...
                    <View style={styles.aBoxDetailContainer}>
                        <View style={styles.topBox}>
                            <View style={styles.boxIndex}>
                                <Text style={styles.boxIndexNumber}>5564</Text>
                            </View>
                            <View style={styles.statusIndicator1}>
                                <FontAwesome5 name='exclamation' size={14} color='#fff'/>
                            </View>
                        </View>
                        <View style={styles.bottomBox}>
                            <Text style={styles.boxTitle}>CO2</Text>
                    ...
                    <View style={styles.aBoxDetailContainer}>
                        <View style={styles.topBox}>
                            <View style={styles.boxIndex}>
                                <Text style={styles.boxIndexNumber}>21.4</Text>
                ...
                <View style={styles.plantDetailsContainer}>
                    ...
                    <View style={styles.aBoxDetailContainer}>
                        <View style={styles.topBox}>
                            <View style={styles.boxIndex}>
                                <Text style={styles.boxIndexNumber}>5.8</Text>
                            </View>
                            <View style={styles.statusIndicator}>
                                <Feather name='check' size={14} color='#fff'/>
                            </View>
                        ...
                        <View style={styles.bottomBox}>
                            <Text style={styles.boxTitle}>EC</Text>
                            <Feather name='wind' size={20} color={Colors.Green}/>
                        </View>
                    </View>
                    <View style={styles.aBoxDetailContainer}>
                        <View style={styles.topBox}>
                            <View style={styles.boxIndex}>
                                <Text style={styles.boxIndexNumber}>5.2</Text>
                        ...
                        <View style={styles.bottomBox}>
                            <Text style={styles.boxTitle}>pH</Text>
                        </View>
                    </View>

                </View>
                <Text style={styles.smallHeader} >My Other Gardens</Text>
